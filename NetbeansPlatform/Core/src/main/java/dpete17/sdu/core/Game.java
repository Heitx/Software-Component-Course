...
public class Game implements ApplicationListener {
    ...
    public void create() {
        ...
        for (IGamePluginService service : Lookup.getDefault().lookupAll(IGamePluginService.class)) {
    ...
    private void update() {
        for (IEntityProcessingService service : Lookup.getDefault().lookupAll(IEntityProcessingService.class)) {
            service.process(gameData, world);
        }
        for (IPostEntityProcessingService service : Lookup.getDefault().lookupAll(IPostEntityProcessingService.class)) {
            service.process(gameData, world);
        }
    }
